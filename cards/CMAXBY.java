...
public class CMAXBY extends CustomCard {
    public static final String ID = "RemiliaMod:CMAXBY";
    ...
    public CMAXBY(final int upgrades) {
        super("RemiliaMod:CMAXBY", CMAXBY.NAME, "images/cards/CMAXBY.png", COST, CMAXBY.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Remilia_Scarlet_Mod, CardRarity.SPECIAL, CardTarget.ALL_ENEMY);
        this.baseDamage = CMAXBY.ATTACK_DMG;
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        CardCrawlGame.sound.playA("RemiliaStringsMod:Remilia_XBY", 0F);
        for (int i = 0; i < 4; i++) {
    ...
    public AbstractCard makeCopy() {
        return new CMAXBY(this.timesUpgraded);
    }

    @Override
    public void upgrade() {
        this.upgradeDamage(CMAXBY.ATTACK_DMG + this.timesUpgraded );
        this.upgradeBaseCost(0);
        ++this.timesUpgraded;
        this.upgraded = true;
        this.name = CMAXBY.NAME + "+" + this.timesUpgraded;
    ...
    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("RemiliaMod:CMAXBY");
        NAME = CMAXBY.cardStrings.NAME;
        DESCRIPTION = CMAXBY.cardStrings.DESCRIPTION;
        UPGRADE_DESCRIPTION = CMAXBY.cardStrings.UPGRADE_DESCRIPTION;
    }
}
