...
public class CBYZLC extends CustomCard {
    ...
    public CBYZLC(final int upgrades) {
        super("RemiliaMod:CBYZLC", CBYZLC.NAME, "images/cards/CBYZLC.png", COST, CBYZLC.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Remilia_Scarlet_Mod, CardRarity.RARE, CardTarget.ALL_ENEMY);
        this.baseDamage = CBYZLC.ATTACK_DMG;
    ...
    public boolean canUse(final AbstractPlayer p, final AbstractMonster m) {
        if (p.hasPower("RemiliaMod:PFWZL") ) {
            if (p.getPower("RemiliaMod:PFWZL").amount >= 15) {
                return true;
            }
        }
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        ...
        CardCrawlGame.sound.playA("RemiliaStringsMod:Remilia_qweq", 0F);
        for (int i = 0; i < 6; i++) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ReducePowerAction(p, p, "RemiliaMod:PFWZL", 15));
        this.upgrade();
    ...
    public AbstractCard makeCopy() {
        return new CBYZLC(this.timesUpgraded);
    }

    @Override
    public void upgrade() {
        this.upgradeDamage(CBYZLC.ATTACK_DMG  + CBYZLC.ATTACK_DMG  + (this.timesUpgraded*4));
        this.upgradeBaseCost(0);
        ++this.timesUpgraded;
        this.upgraded = true;
        this.name = CBYZLC.NAME + "+" + this.timesUpgraded;
    ...
    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("RemiliaMod:CBYZLC");
        NAME = CBYZLC.cardStrings.NAME;
        DESCRIPTION = CBYZLC.cardStrings.DESCRIPTION;
        UPGRADE_DESCRIPTION = CBYZLC.cardStrings.UPGRADE_DESCRIPTION;
    }
}
